 ...
 */
class users_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new ReportField('users_base', 'users', 'x_id', 'id', '`id`', 3, -1, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// username
		$this->username = new ReportField('users_base', 'users', 'x_username', 'username', '`username`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->username->Sortable = TRUE; // Allow sort
		$this->username->DateFilter = "";
		$this->fields['username'] = &$this->username;

		// user_type
		$this->user_type = new ReportField('users_base', 'users', 'x_user_type', 'user_type', '`user_type`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_type->Sortable = TRUE; // Allow sort
		$this->user_type->DateFilter = "";
		$this->fields['user_type'] = &$this->user_type;

		// password
		$this->password = new ReportField('users_base', 'users', 'x_password', 'password', '`password`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->password->Sortable = TRUE; // Allow sort
		$this->password->DateFilter = "";
		$this->fields['password'] = &$this->password;

		// hospcode
		$this->hospcode = new ReportField('users_base', 'users', 'x_hospcode', 'hospcode', '`hospcode`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->hospcode->Sortable = TRUE; // Allow sort
		$this->hospcode->DateFilter = "";
		$this->fields['hospcode'] = &$this->hospcode;

		// hospname
		$this->hospname = new ReportField('users_base', 'users', 'x_hospname', 'hospname', '`hospname`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->hospname->Sortable = TRUE; // Allow sort
		$this->hospname->DateFilter = "";
		$this->fields['hospname'] = &$this->hospname;
	}
