 ...
 */
class test_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		// mem_id
		$this->mem_id = new ReportField('test_base', 'test', 'x_mem_id', 'mem_id', '`mem_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'NO');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`test`";
	}
