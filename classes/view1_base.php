...
class view1_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		// mem_name
		$this->mem_name = new ReportField('view1_base', 'view1', 'x_mem_name', 'mem_name', '`mem_name`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mem_name->Sortable = TRUE; // Allow sort
		$this->mem_name->DateFilter = "";
		$this->fields['mem_name'] = &$this->mem_name;

		// mem_id
		$this->mem_id = new ReportField('view1_base', 'view1', 'x_mem_id', 'mem_id', '`mem_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'NO');
