...
class custom
{
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'custom.php');
	...
	public function run()
	{
		global $ExportType, $ExportFileName, $ReportLanguage, $Security, $UserProfile, $CustomExportType;
		global $ReportLanguage;
	...
	{
		global $Breadcrumb, $ReportLanguage;
		$Breadcrumb = new Breadcrumb();
		$url = substr(CurrentUrl(), strrpos(CurrentUrl(), "/") + 1);
		$Breadcrumb->add("custom", "custom", $url, "", "custom", TRUE);
		$this->Heading = $ReportLanguage->tablePhrase("custom", "TblCaption"); 
	}
