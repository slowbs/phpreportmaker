...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'GXT3yOtIt6R5v9Zn'); // Random key for encryption
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "slowbs", "pass" => "sodsongig4", "db" => "apigular", "qs" => "`", "qe" => "`");
