...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="mem_name"><div class="view1_mem_name"><span class="ew-table-header-caption"><?php echo $Page->mem_name->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="mem_name">
<?php if ($Page->sortUrl($Page->mem_name) == "") { ?>
		<div class="ew-table-header-btn view1_mem_name">
			<span class="ew-table-header-caption"><?php echo $Page->mem_name->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view1_mem_name" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->mem_name) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->mem_name->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="mem_id"><div class="view1_mem_id"><span class="ew-table-header-caption"><?php echo $Page->mem_id->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="mem_id">
<?php if ($Page->sortUrl($Page->mem_id) == "") { ?>
		<div class="ew-table-header-btn view1_mem_id">
			<span class="ew-table-header-caption"><?php echo $Page->mem_id->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view1_mem_id" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->mem_id) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->mem_id->caption() ?></span>
