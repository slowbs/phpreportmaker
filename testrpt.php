...
<div id="ew-center" class="<?php echo $test_rpt->CenterContentClass ?>">
<?php } ?>
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_test" class="<?php if (IsResponsiveLayout()) { echo "table-responsive "; } ?>ew-grid-middle-panel">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="mem_id"><div class="test_mem_id"><span class="ew-table-header-caption"><?php echo $Page->mem_id->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="mem_id">
<?php if ($Page->sortUrl($Page->mem_id) == "") { ?>
		<div class="ew-table-header-btn test_mem_id">
			<span class="ew-table-header-caption"><?php echo $Page->mem_id->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer test_mem_id" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->mem_id) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->mem_id->caption() ?></span>
